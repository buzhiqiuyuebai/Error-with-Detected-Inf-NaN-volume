...
Point(1) = {40, 40, -80, cl_1};
Point(2) = {40, 40, 80, cl_1};
Point(3) = {-40, 40, 80, cl_1};
Point(4) = {-40, 40, -80, cl_1};
Point(5) = {-40, -40, -80, cl_1};
Point(6) = {-40, -40, 80, cl_1};
Point(7) = {40, -40, 80, cl_1};
Point(8) = {40, -40, -80, cl_1};
...
Surface Loop(2) = {1,32, 34, 36, 38, 40, 42};
Volume(2) = {2};
